  ...
  function iniciarArmazenamentoOtimizado(){
    ...
    (async()=>{
      try{
        ...
        await migrarEstadoAtualParaIndexedDB();
        await hidratarImagensDoIndexedDB();
        setTimeout(limparImagensOrfas, 700);
      }catch(err){
        console.error("Falha na migração automática das imagens.", err);
      }
    })();
  }
