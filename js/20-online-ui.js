  ...
  function renderNuvem(st){
    ...
    return `<section class="onlineCard onlineSyncPainel">
      ...
      <div class="onlineSyncSecao">
        ...
        <p class="onlineSyncExplicacao">O backup não participa da sincronização em tempo real. Ao fazer um novo backup desta ficha, ele substitui o backup anterior da mesma ficha — sem criar outra personagem.</p>
        <div class="onlineAcoesLinha">
